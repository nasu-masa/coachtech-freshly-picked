...
class ProductsSeeder extends Seeder
{
    public function run()
    {
        ...
        // public/products → storage/products にコピー
        foreach ($files as $file) {
            $from = public_path('images/products/' . $file);
            $to   = storage_path('app/public/products/' . $file);
        ...
        DB::table('products')->insert([
            ...
            [
                'name'        => 'オレンジ',
                'price'       => 850,
                'description' => '当店では酸味と甘みのバランスが抜群なネーブルオレンジを使用しています。酸味は控えめで、甘さと濃厚な果汁が魅力の商品です。もぎたてフルーツのスムージをお召し上がりください！',
